...
lblqoute = Label(root, text="Qoute Of The Day:", font=("courier", 20, "normal"))
lblqouteans = Label(root, text="", font=("Century School", 15, "bold italic"))
lblqouteans1 = Label(root, text="", font=("Century School", 15, "bold italic"))
lblqouteans2 = Label(root, text="", font=("Century School", 15, "bold italic"))

lblcity = Label(root, text="City:", font=("courier", 20, "normal"))
lblcityans = Label(root, text="", font=("courier", 20, "bold"))
lbltemp = Label(root, text="Temperature:", font=("courier", 20, "normal"))
lbltempans = Label(root, text="", font=("courier", 20, "bold"))
